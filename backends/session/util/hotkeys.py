...
class Hotkeys():
    ...
    def __init__(self):
        ...
        # This is needed because if the file is empty, xbindkeys will kill
        # itself ungracefully.
    ...
    def __update_hotkey(self, command, hotkey):
        ...
        try:
            ...
            sessionlog.write(
                "ERROR: 'Hotkeys.__update_hotkey()' - Cannot replace '" +
                XBINDKEYS_CONFIG_FILE +
                "'.")
    ...
    def __remove_hotkey(self, command):
        ...
        if commandfound == True:
            try:
                ...
                sessionlog.write(
                    "ERROR: 'Hotkeys.__remove_hotkey()' - Cannot replace '" +
                    XBINDKEYS_CONFIG_FILE +
                    "'.")
                os.remove(XBINDKEYS_CONFIG_FILE + ".new")
                return False
    ...
    def __stop_daemon(self):
        ...
        while returncode == 0:
            try:
                ...
                sessionlog.write(
                    "ERROR: 'Hotkeys.__stop_daemon()' - COMMAND: '" +
                    command +
                    "' - Exception thrown.")
                return
    ...
    def __restart_daemon(self):
        ...
        try:
            ...
            sessionlog.write(
                "ERROR: 'Hotkeys.__restart_daemon()' - COMMAND: '" +
                command +
                "' - Exception thrown.")
