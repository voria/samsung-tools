...
CPU_STATUS_NORMAL = _("CPU mode is 'normal'")
CPU_STATUS_SILENT = _("CPU mode is 'silent'")
CPU_STATUS_SPEED = _("CPU mode is 'speed'")
CPU_STATUS_ERROR = _("Cannot get CPU mode")
