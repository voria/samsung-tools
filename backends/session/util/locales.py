...
CPU_TITLE = _("CPU/Fan")
CPU_TEMPERATURE = _("CPU Temperature:")
FAN_SWITCH_NORMAL = _("Fan mode changed: Normal")
FAN_SWITCH_SILENT = _("Fan mode changed: Silent")
FAN_SWITCH_SPEED = _("Fan mode changed: Speed")
FAN_SWITCHING_ERROR = _("Fan mode cannot be changed")
FAN_STATUS_NORMAL = _("Fan mode: Normal")
FAN_STATUS_SILENT = _("Fan mode: Silent")
FAN_STATUS_SPEED = _("Fan mode: Speed")
FAN_STATUS_ERROR = _("Cannot get fan mode")
FAN_NOT_AVAILABLE = _("Fan control is not available")
