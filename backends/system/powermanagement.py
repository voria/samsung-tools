...
OLD_SYSCTL_CONFIG_FILE = "/etc/sysctl.d/30-samsung-tools.conf"
...
class SysCtl(dbus.service.Object):
	...
	def SetSwappiness(self, value, sender = None, conn = None):
		# Make sure old configuration file is removed
		if os.path.exists(OLD_SYSCTL_CONFIG_FILE):
			os.remove(OLD_SYSCTL_CONFIG_FILE)
